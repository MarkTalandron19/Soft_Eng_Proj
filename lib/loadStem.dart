...
class LoadStem extends StatefulWidget {
  const LoadStem({super.key, required this.isChild, required this.password});

  final String password;
  final bool isChild;
  @override
  State<LoadStem> createState() => _DepositState();
}

class _DepositState extends State<LoadStem> {
  int amount = 0;
