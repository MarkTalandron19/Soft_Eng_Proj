...
class LoadPLDC extends StatefulWidget {
  const LoadPLDC({super.key, required this.isChild, required this.password});

  final String password;
  final bool isChild;
  @override
  State<LoadPLDC> createState() => _DepositState();
}

class _DepositState extends State<LoadPLDC> {
  int amount = 0;
