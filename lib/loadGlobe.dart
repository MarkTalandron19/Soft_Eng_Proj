...
class LoadGlobe extends StatefulWidget {
  const LoadGlobe({super.key, required this.isChild, required this.password});

  final String password;
  final bool isChild;
  @override
  State<LoadGlobe> createState() => _DepositState();
}

class _DepositState extends State<LoadGlobe> {
  int amount = 0;
